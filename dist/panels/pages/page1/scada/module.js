...
var TaqniaPage1ScadaPanelCtrl = /** @class */ (function (_super) {
    ...
    function TaqniaPage1ScadaPanelCtrl($scope, $injector, $element) {
        ...
        _this.svgFilePath = "public/plugins/" + _common__WEBPACK_IMPORTED_MODULE_1__["appId"] + "/img/scada.svg";
        _this._svg = null;
        _this.events.on('panel-initialized', _this.onInitialized.bind(_this));
        _this.events.on('data-received', _this.onDataReceived.bind(_this));
        return _this;
    }
    Object.defineProperty(TaqniaPage1ScadaPanelCtrl.prototype, "container", {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        // svg first child
                        this.svg = snapsvg__WEBPACK_IMPORTED_MODULE_2___default()(node.find("> svg")[0]);
                        return [3 /*break*/, 4];
                    case 3:
                        e_1 = _a.sent();
                        console.error(e_1);
    ...
    TaqniaPage1ScadaPanelCtrl.prototype.getContainer = function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        snapsvg__WEBPACK_IMPORTED_MODULE_2___default.a.load(path, resolve);
                    })];
            });
        });
    };
