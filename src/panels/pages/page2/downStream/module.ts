...
class ProjTaqniaPage2DownstreamPanelCtrl extends MetricsPanelCtrl {
    static template = require(`./partial/template.html`);
    divID: String = "taqnia-page2-downstream-panel";
...
export {
    ProjTaqniaPage2DownstreamPanelCtrl as PanelCtrl
};
