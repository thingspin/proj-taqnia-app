...
class ProjTaqniaPage2MiddlestreamPanelCtrl extends MetricsPanelCtrl {
    static template = require(`./partial/template.html`);
    divID: String = "taqnia-page2-middlestream-panel";
...
export {
    ProjTaqniaPage2MiddlestreamPanelCtrl as PanelCtrl
};
